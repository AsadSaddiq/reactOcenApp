...
import { useCreateElectronicsApiMutation } from "../../../redux/features/electronics/electronics.service";
...
const ElectronicsForm = () => {
  ...
  const [createElectronics] = useCreateElectronicsApiMutation();
  ...
  const onFinish = async (values) => {
    ...
    try {
      const res = await createElectronics(formData).unwrap();
      console.log(res);
      if (res.status === 204) {
        navigate("/admin");
      } else {
